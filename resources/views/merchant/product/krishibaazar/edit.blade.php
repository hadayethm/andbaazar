                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="mt-0">
                                                    <img id="output"  class="imagestyle" src="{{ (!is_null($krishiproduct->thumbnail_image)) ? Storage::url('/app/public/'.$krishiproduct->thumbnail_image) : asset('/images/demo-product.jpg') }}" /> 
                                                </div>
                                                <div class="uploadbtn">
